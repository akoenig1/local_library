...
exports.book_detail = function(req, res, next) {
    async.parallel({
        ...
        if(results.book==null) { //No results
            var err = new Error('Nook not found');
            err.status = 404;
            return next(err);
        }
        //Successful, so render
...
exports.book_create_get = function(req, res, next) {
    // Get all authors and genres we can use for adding to our book
    async.parallel({
...
exports.book_create_post = [
    ...
    (req, res, next) => {
        ...
        if(!errors.isEmpty()) {
            // There are errors. Re-render form again with sanitized values/error messages
...
exports.book_delete_post = function(req, res, next) {
    async.parallel({
        ...
        if(results.book_instances.length > 0) {
            ...
            // Book has no instances. Delete object and redirect to list of authors
